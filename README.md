...
cp Awesome_ClaudeMD/asinit_AwosomeCLAUDE.md ~/.claude/commands/asinit.md
```
...
Copy-Item "Awesome_ClaudeMD\asinit_AwosomeCLAUDE.md" "$env:USERPROFILE\.claude\commands\asinit.md"
```
...
cd Awesome_ClaudeMD
git pull origin main
Copy-Item "asinit_AwosomeCLAUDE.md" "$env:USERPROFILE\.claude\commands\asinit.md"
```
