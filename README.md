...
curl -sL https://raw.githubusercontent.com/LeonSGP43/Awesome_ClaudeMD/main/asinit_AwosomeCLAUDE.md -o ~/.claude/commands/asinit.md
```

**Windows (PowerShell)：**
```powershell
New-Item -ItemType Directory -Force -Path "$env:USERPROFILE\.claude\commands"
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/LeonSGP43/Awesome_ClaudeMD/main/asinit_AwosomeCLAUDE.md" -OutFile "$env:USERPROFILE\.claude\commands\asinit.md"
```
